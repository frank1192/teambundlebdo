...
|---|---|---|---|---|
|DESARROLLO|N/A|N/A|N/A|N/A|
|CALIDAD|WSP|wsp_int_iib_02|BODPQAS|http://boc201.tesint.app.bancodeoccidente.net:7866/accounts/BalanceInquiry|
|PRODUCCION|WSP|wsp_int_iib_02|BODPPRD|http://boc201.prdint.app.bancodeoccidente.net:7866/accounts/BalanceInquiry|

### Endpoint BUS 
|AMBIENTE|    NODO/GE    |ENDPOINT|
|---|----------|---|
|DESARROLLO|BOGESERVICIOSWS_ICBS02|https://adbog19ds:4922/accounts/BalanceInquiry|
|CALIDAD|BOGESERVICIOSWS_ICBS02|https://atbog110d:4922/accounts/BalanceInquiry|
...
|Servicios|
|---|
|ConsultaSaldoTarjetaCredito|
|IntegracionAS400Leasing|
|IntegracionEtiquetasSAM|
|IntegracionFCUBS_Asincronico|
|IntegracionPaquetesAc|
|IntegracionSP|
|Util|
...
**WSDL:**     
git/ESB_ACE12_AperturaCuenta/Broker/WSDL/wsdl/BalanceInquiry.wsdl  

## SQL
- Operación getBalanceByProduct
```
select *
from admesb.esb_log_auditoria
where str_id_oper_apl_origen = 'getBalanceByProduct'
;
```
- Operación getBalanceByProductOnline
```
select *
from admesb.esb_log_auditoria
where str_id_oper_apl_origen = 'getBalanceByProductOnline'
;
```
- Operación getBalanceGroupedByProduct
```
select *
from admesb.esb_log_auditoria
where str_id_oper_apl_origen = 'getBalanceGroupedByProduct'
;
```